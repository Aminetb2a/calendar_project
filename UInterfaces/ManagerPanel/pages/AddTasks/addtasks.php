        ...
        <div id="page-wrapper">
            ...
            <!-- /.container-fluid -->
				...
				<?php
					...
					<body>
					<form action="addtasks_submit.php?ids=<?php echo $_SESSION['sess_username'];?>" method="post">
					<!--<h2>Add user</h2>-->
					<fieldset>
					...
					<div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input type="text" id="title" name="title" value="" maxlength="20"  class="form-control">
					...
					<div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input type="text" id="manager" name="manager" value="<?php echo $_SESSION['sess_username'] ?>" maxlength="20"  class="form-control"readonly>
                                          <span class="help-block"></span>
                                      </div>
                                  </div>
                    <div class="form-group">
					...
					<!--div class="form-group">
                                      <label class="col-sm-2 control-label">Periority</label>
                                      <div class="col-sm-10">
